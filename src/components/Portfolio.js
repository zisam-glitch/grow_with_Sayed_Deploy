        ...
        <div className="container">
          ...
          <div className="portfolio_filter">
            <ul>
              ...
              <li>
                <a onClick={handleFilterKeyChange("detail")}>Websites</a>
              </li>
              <li>
            ...
            <ul className="gallery_zoom">
              <li className="filter-item detail">
                <div className="list_inner">
                  <div className="image">
                    ...
                    <div className="main" data-img-url="img/portfolio/1.3.jpg" />
                  </div>
              ...
              <li className="filter-item detail">
                <div className="list_inner">
                  <div className="image">
                    <img src="img/thumbs/1.1.jpg" alt="aali image" />
                    <div className="main" data-img-url="img/portfolio/1.4.jpg" />
                  </div>
                  <div className="overlay" />
                  {text}
                  <div className="details">
              ...
              <li className="filter-item detail">
                <div className="list_inner">
                  <div className="image">
                    <img src="img/thumbs/1.1.jpg" alt="aali image" />
                    <div className="main" data-img-url="img/portfolio/1.1.jpg" />
                  </div>
                  <div className="overlay" />
                  {text}
                  <div className="details">
              ...
              <li className="filter-item detail">
                <div className="list_inner">
                  <div className="image">
                    <img src="img/thumbs/1.1.jpg" alt="aali image" />
                    <div className="main" data-img-url="img/portfolio/1.2.jpg" />
                  </div>
                  <div className="overlay" />
                  {text}
                  <div className="details">
              ...
              <li className="filter-item detail">
                <div className="list_inner">
                  <div className="image">
                    <img src="img/thumbs/1.1.jpg" alt="aali image" />
                    <div className="main" data-img-url="img/portfolio/1.5.jpg" />
                  </div>
                  <div className="overlay" />
                  {text}
                  <div className="details">
